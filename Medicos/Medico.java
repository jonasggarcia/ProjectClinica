...
public class Medico extends GenericDomain {
	...
	private String especialidadesRelatorio;
	...
	public String getEspecialidadesRelatorio() {
		...
		especialidadesRelatorio = buf.toString().substring(0, buf.toString().length() - 1);
		return especialidadesRelatorio;
	}

	public void setEspecialidadesRelatorio(String especialidadesRelatorio) {
		this.especialidadesRelatorio = especialidadesRelatorio;
	}
